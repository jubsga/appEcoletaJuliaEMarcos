        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Image style={styles.pointImage}
                    source={{ uri: 'https://f.i.uol.com.br/fotografia/2019/08/16/15659855445d570b082fe09_1565985544_3x2_md.jpg' }} />

                <Text style={styles.pointName}>Centro Histórico</Text>
                <Text style={styles.pointItems}>Lampadas, Óleo de cozinha</Text>
                <View style={styles.address}>
                    <Text style={styles.addressTitle}>Endereço</Text>
                    <Text style={styles.addressContent}>Centro de Santana de Parnaíba -SP</Text>
                </View>
            </View>
